...
## 📝 Описание
Проект предназначен для новичков, изучающих Python с целью научится визуализировать математические функции с использованием профессиональных инструментов программирования и различных Python-библиотек.<br> Поддерживает создание как статических, так и интерактивных графиков.
