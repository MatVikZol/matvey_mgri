...
```
**matplolib** - библиотека для построения статических графиков и сохранения в формате PNG;
**numpy** - библиотека для генерации диапазона значений **X** и вычисления значений функции **Y**;
**ploty** - библиотека для создания **интерактивных графиков**, которые возможно просматривать в браузере.<br>

Или установите большинство библиотек используемые в Python из файла requirements.txt
```bash
